package com.ghoe.snapsaver.whatsapp_code.activity;
...
import com.ghoe.snapsaver.BuildConfig;
...
import com.ghoe.snapsaver.whatsapp_code.adapter.StickerDetailsAdapter;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static com.ghoe.snapsaver.activity.StickerMakerActivity.EXTRA_STICKER_PACK_AUTHORITY;
import static com.ghoe.snapsaver.activity.StickerMakerActivity.EXTRA_STICKER_PACK_ID;
import static com.ghoe.snapsaver.activity.StickerMakerActivity.EXTRA_STICKER_PACK_NAME;
...
public class StickerDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (com.ghoe.snapsaver.whatsapp_code.Sticker s : stickers) {
            if (!file.exists()) {
