package com.ghoe.snapsaver.whatsapp_code;
...
public class StickerPack implements Parcelable {
    ...
    public static final Creator<StickerPack> CREATOR = new Creator<StickerPack>() {
        @Override
        public com.ghoe.snapsaver.whatsapp_code.StickerPack createFromParcel(Parcel in) {
            return new com.ghoe.snapsaver.whatsapp_code.StickerPack(in);
        }

        @Override
        public com.ghoe.snapsaver.whatsapp_code.StickerPack[] newArray(int size) {
            return new com.ghoe.snapsaver.whatsapp_code.StickerPack[size];
        }
    };
