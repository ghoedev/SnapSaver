package com.ghoe.snapsaver.whatsapp_code.provider;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        for (com.ghoe.snapsaver.whatsapp_code.StickerPack stickerPack : getStickerPackList()) {
    ...
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<StickerPack> stickerPackList) {
        ...
        for (com.ghoe.snapsaver.whatsapp_code.StickerPack stickerPack : stickerPackList) {
